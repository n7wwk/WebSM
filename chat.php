...
<html>
    <head>
    <title>WebIMS Chat)</title>
    <style type="text/css">
body             { padding-left:5px; background:#white; font-family:arial;}
input, textarea  { font-family: courier new; font-size: 12px; }
#content         { width:800px; text-align:left; margin-left:100px; }

#chatwindow      { border:1px solid #aaaaaa; padding:4px; background:#white; color:blue;}
...
#info td         { font-size:12px; padding-right:10px; color:#blue;  }
#info .small     { font-size:10px; padding-left:10px; padding-right:0px; }

#info a          { text-decoration:none; color:green; }
#info a:hover    { text-decoration:underline; color:#blue; }
</style>
    </head>
    <body>
        <div id="info">
        <br>
            <table border="0">
                <tr>
                    <td colspan="2">
                        <font color ="green" style="font-size:24px">WebIMS Chat Server</font><br>
                    </td>
                </tr>
                <tr>
                    <td class="small"></td>
